                        ...
                        if (event.target.tagName !== 'H4') {
                            ...
                            if (event.target.tagName === 'H4') {
                                if (secilenAltBaslik == "Kredi Dosya Masrafı Hesaplama Aracı") {
                                    ...
                                    hesaplaPop.innerHTML = `<div style="margin-top: -50px;"><h3>| ${secilenAltBaslik} |</h3></div><form><b>Kredi Tutarı:</b><div><input type="number" name="" id="dmGiris"><input type="submit" value="Hesapla" id="dmHesapla"></div></form>`
                                    ...
                                    dmHesapla.addEventListener('click', function (event) {
                                        ...
                                        if (dmGiris.value == '') {
                                            ...
                                            hesaplaPop.innerHTML = `<div>
                                                                    ...
                                                                    </div><b>Kredi Dosya Masrafınız:</b><span>${KDM} TL'dir.</span>
                                                                </div>
                                                                <p>Burada hesaplanan dosya masrafı tutarı, kredi veren kuruluş tarafından kredi kullanan müşteriden istenebilecek en
                                                                    yüksek dosya masrafı tutarını belirtmektedir. Kredi veren kuruluş, kredi çeken müşteriden kredi kullanımı esnasında
                                                                    dosya masrafına ek olarak sigorta, ipotek ve ekspertiz masrafı gibi ücretler isteyebilmektedir. Bu ücretler dosya
                                                                    masrafına dahil değildir. Çünkü bu ücretler kredi veren kuruluşlarca işlemi yapan kuruluşlara (sigorta şirketlerine,
                                                                    ekspertiz firmalarına vs.) aktarılmak üzere tahsil edilmektedir.</p>`
                                        }
                                    })
                                    ...
                                    hesaplaPop.innerHTML = `
                                                        ...
                                                        <div style="background-color: #2D3940;color: #fff;margin-bottom: 20px; padding:5px 5px;border-radius: 4px;">NOT: Konut
                                                            dışı kredilerde erken kapatma cezası alınmamaktadır.</div>
                                                        <form style="display: flex;flex-direction: column;row-gap: 10px;"><b>Kredi Türü:Konut Kredisi</b>
                                                            <div>
                                                                <div>
                                                                    <label for="radioVade1"><b>1-36 Ay</b></label>
                                                                    <input type="radio" name="vade" id="radioVade1" value="1-36Ay">
                                                                </div>
                                                                <div>
                                                                    <label for="radioVade2"><b>36+ Ay</b></label>
                                                                    <input type="radio" name="vade" id="radioVade2" value="36+Ay">
                                                                </div>

                                                            </div>
                                                            <div><b>Erken Ödeme Tutarı: </b><input type="number" name="" id="erkenKapatma"><input type="submit" value="Hesapla"
                                                                    id="ekHesaplama"></div>
                                                        </form>
                                                        `
                                    event.preventDefault()
                                    ...
                                    ekHesaplama.addEventListener('click', function (event) {
                                        ...
                                        if (erkenKapatma.value == '') {
                                            ...
                                            if (selectedRadio.value == '1-36Ay') {
                                                hesaplaPop.innerHTML = `<div><h3>${secilenAltBaslik} Sonuçları</h3></div>
                                            <div style="display:flex;flex-direction: column; row-gap:20px"><b>Maksimum Erken Kapatma Tazminatı Oranı: </b>Kalan kredi vadesi 36 aydan az olan konut kredilerinde genelde %1 olarak uygulanmaktadır. Kredi sözleşmenizi inceleyerek hangi oranda ceza ödeyeceğinizi kesinleştirebilirsiniz.</div>
                                            <div><b>Maksimum Erken Kapatma Tazminatı Tutarı:</b> ${erkenKapatma.value / 100} TL</div>`
                                            } else if (selectedRadio.value == '36+Ay') {
                                                hesaplaPop.innerHTML = `<div><h3>${secilenAltBaslik} Sonuçları</h3></div>
                                            <div style="display:flex;flex-direction: column; row-gap:20px"><b>Maksimum Erken Kapatma Tazminatı Oranı: </b>Kalan kredi vadesi 36 aydan az olan konut kredilerinde genelde %2 olarak uygulanmaktadır. Kredi sözleşmenizi inceleyerek hangi oranda ceza ödeyeceğinizi kesinleştirebilirsiniz.</div>
                                            <div><b>Maksimum Erken Kapatma Tazminatı Tutarı:</b> ${(erkenKapatma.value / 100) * 2} TL</div>`
                                    ...
                                    hesaplaPop.innerHTML = `<div>
                                                            <h3>| ${secilenAltBaslik} |</h3>
                                                            <div style="background-color: #2D3940;color: #fff;margin-bottom: 20px; padding:5px 5px;border-radius: 4px;">NOT: Hesaplama aracımız BDDK'nın 26.09.2024 tarihinde yürürlüğe giren yeni kredi kartı düzenlemesine göre işlem yapmaktadır.</div>
                                                            <form style="display:flex;flex-direction: column; row-gap:20px">
                                                            <div><b>Dönem Borcu: </b><input type="number" name="" id="donemBorcu"></div>
                                                            <div><b style="margin-right: 14px;">Kart Limiti: </b><input type="number" name="" id="kartLimiti"></div>
                                                            <input type="submit" value="Hesapla" id="asgariHesapla"></form>
                                                        </div>`
                                            ...
                                            hesaplaPop.innerHTML = `
                                                                <div>
                                                                    ...
                                                                    <div style="display: flex;flex-direction: column;row-gap: 5px;">
                                                                        <div><b>Dönem Borcu: </b>${donemBorcu.value} TL</div>
                                                                        <div><b>Ödenmesi Gereken Asgari Tutar:</b> ${(donemBorcu.value / 100) * 20} TL</div>
                                                                        <div><b>Asgari Ödeme Sonrası Borç Bakiyesi:</b>${(donemBorcu.value / 100) * 80} TL</div>
                                                                        <div><b>Kalan Borç İçin Günlük Gecikme Faizi Tutarı:</b>${sonuc} TL</div>
                                                                        <div style="background-color: #2D3940;color: #fff;margin-bottom: 20px; padding:5px 5px;border-radius: 4px;">
                                                                            Bilgi: Asgari ödeme yapılması durumunda kalan borç için günlük gecikme faizi hesaplanırken, güncel akdi faiz
                                                                            oranı olan %4,25 kullanılmıştır. Hesaplanan gecikme faizine BSMV ve KKDF dahildir.</div>
                                                                    </div>
                                                                </div>
                                                                `
                                        }
                                    ...
                                    hesaplaPop.innerHTML = `<div>
                                                            ...
                                                            <form style="flex-direction: column;row-gap: 10px;">
                                                                <div>
                                                                    ...
                                                                    <b>İşlem Türü </b>
                                                                        <div id="radioChange">
                                                                        <div><label for="onsTl">Altından Paraya</label>
                                                                        <input type="radio" name="altinPara" id="onsTl" value="altPara"></div>
                                                                        <div><label for="tlOns">Paradan Altına</label>
                                                                        <input type="radio" name="altinPara" id="tlOns" value="paraAlt"></div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <b>Miktar: </b><input type="number" name="" id="altinGiris"> gram (Örn: 25 gram) 
                                                                <input type="submit" value="Hesapla" id="aldanPar">
                                                                </div>
                                                                <div id="pardiv" style="display:none;">
                                                                <b>Tutar: </b><input type="number" name="" id="tlGiris"> TL (Örn: 12500 TL) 
                                    ...
                                    aldanPar.addEventListener('click', function (event) {
                                        ...
                                        if (onsTlRadio.checked) {
                                            if (altinTuru.value == '' || altinGiris.value == '') {
                                                alert('Tüm alanları dolu olduğuna emin olunuz')
                                            } else {
                                                hesaplaPop.innerHTML = `<div style="display:flex; flex-direction:column; row-gap:10px;">
                                                                        ...
                                                                        <div style="background-color: #2D3940;color: #fff;margin-bottom: 20px; padding:5px 5px;border-radius: 4px;">
                                                                            <b>Bilgi:</b> Bu hesaplama 02.05.2025 23:00 tarihindeki piyasa verileri kullanılarak yapılmıştır</div>
                                                                    </div>`
                                            }
                                        }
                                    })
                                    ...
                                    hesaplaPop.style = "display:flex;flex-direction: column;justify-content: center;"
                                    hesaplaPop.innerHTML = `<div>
                                                            <div><h3>| ${secilenAltBaslik} |</h3></div>
                                                            <form style="flex-direction: column;row-gap: 10px;">
                                                                    <div>
                                                                        <b>İşlem Türü </b>
                                                                        <div id="radioChangeDolar">
                                                                            <div><label for="dolarTl">Dolar'dan Lira'ya</label>
                                                                            <input type="radio" name="dolarLira" id="dolarTl" value="dolarLira"></div>
                                                                            <div><label for="tlDolar">Lira'dan Dolara</label>
                                                                            <input type="radio" name="dolarLira" id="tlDolar" value="liraDolar"></div>
                                                                        </div>
                                                                    </div>
                                                                <div id="dolarDiv">
                                                                    <b>Tutar: </b><input type="number" name="" id="dolarGiris"> 
                                    ...
                                    dolardanLira.addEventListener('click', function (event) {
                                        ...
                                        if (dolarLiraRadio.checked) {
                                            ...
                                            alert('Tüm alanların dolu olduğuna emin olun.')
                                        }
                                    })
                                                            ...
                                                            <form style="flex-direction: column;row-gap: 10px;">
                                                                    <div>
                                                                        ...
                                                                        <div id="radioChangeEuro">
                                                                            <div><label for="euroTl">Euro'dan Lira'ya</label>
                                                                            <input type="radio" name="euroLira" id="euroTl" value="euroLira"></div>
                                                                            <div><label for="tlEuro">Lira'dan Euro'ya</label>
                                                                            <input type="radio" name="euroLira" id="tlEuro" value="liraEuro"></div>
                                                                        </div>
                                                                    </div>
                                                                <div id="euroDiv">
                                                                <b>Tutar: </b><input type="number" name="" id="euroGiris"> 
                                    ...
                                    hesaplaPop.innerHTML = `<div>
                                                            ...
                                                            <form style="flex-direction: column;row-gap: 10px;">
                                                                    ...
                                                                    <b>İşlem Türü </b>
                                                                        ...
                                                                        <div><label for="sterlinTl">Sterlin'den Lira'ya</label>
                                                                        <input type="radio" name="sterlinLira" id="sterlinTl" value="sterlinLira"></div>
                                                                        <div><label for="tlSterlin">Lira'dan Sterlin'e</label>
                                                                        <input type="radio" name="sterlinLira" id="tlSterlin" value="liraSterlin"></div>
                                                                        </div>
                                                                    </div>
                                                                <div id="euroDiv">
                                                                <b>Tutar: </b><input type="number" name="" id="sterlinGiris"> 
                                    ...
                                    hesaplaPop.innerHTML = `
                                                        <form style="flex-direction: column;">
                                                            <div>
                                                                <div style="background-color: #2D3940;color: #fff;margin-top: 10px; padding:5px 5px;border-radius: 4px;"><b>NOT:
                                                                    </b>2023 - 2024 eğitim yılı ve sonrasına (2024 - 2025 dahil) uyumlu olarak hazırlanmıştır. Puanını boş
                                                                    bıraktığınız kısımlar ortalama hesaplamalarına dahil edilmeyecektir.</div>
                                                                <div><h3 style="margin: 13px 0px;">| ${secilenAltBaslik} |</h3></div>
                                                                <table>
                                                                    <tbody>
                                                                        <tr id="tr"
                                                                            style="display:flex; flex-direction:column; row-gap:5px;align-items: end;margin-left: 80px;">
                                                                            <td><div><b>1. Yazılı Sınav:</b><input type="number" name="" id="sinav"></div></td>
                                                                            <td><div><b>2. Yazılı Sınav:</b><input type="number" name="" id="sinavv"></div></td>
                                                                            <td><div><b>1. Performans Görevi: </b><input type="number" name="" id="etkinlik"></div></td>
                                                                            <td><div><b>2. Performans Görevi: </b><input type="number" name="" id="etkinlikk"></div></td>
                                                                            <td><div><b>3. Ders Etkinlik Katılım: </b><input type="number" name="" id="etkinlikkk"></div></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </div>
                                                            <input type="submit" value="Hesapla" id="dersHesapla" style="width:67%; margin-top:5px;"></div>
                                                        </form>
                                                        `
                                    ...
                                    hesaplaPop.style = "display:flex;flex-direction: column;justify-content: flex-start;"
                                    hesaplaPop.innerHTML = `<form style = "flex-direction: column;">
                                                            <div style="display: flex;flex-direction: row;align-items: normal;">
                                                                    ...
                                                                    <table>
                                                                        <tbody>
                                                                            <tr id="tr" style="display:flex; flex-direction:column; row-gap:5px;align-items: end;margin-left: 80px;">
                                                                                <td><div><b>1. Yazılı Sınav:</b><input type="number" name="" id="sinav1"></div></td>
                                                                                <td><div><b>2. Yazılı Sınav:</b><input type="number" name="" id="sinav2"></div></td>
                                                                                <td><div><b>1. Performans Görevi: </b><input type="number" name="" id="performans1"></div></td>
                                                                                <td><div><b>2. Performans Görevi: </b><input type="number" name="" id="performans2"></div></td>
                                                                                <td><div><b>1.Uygulama: </b><input type="number" name="" id="uygulama1"></div></td>
                                                                                <td><div><b>2.Uygulama: </b><input type="number" name="" id="uygulama2"></div></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                            </div>
                                                            <div style="width: 177px;margin-left: 317px;"><input type="submit" value="Hesapla" id="liseDersHesapla" style="height: 22px; width:100%"></div>
                                                        </form>`
                                    ...
                                    liseDersHesapla.addEventListener('click', function (event) {
                                        ...
                                        if (sinav1.value == "" && sinav2.value == "" && performans1.value == "" && performans2.value == "" && uygulama1.value == "" && uygulama2.value == "") {
                                            ...
                                            hesaplaPop.innerHTML = `<h3>${secilenAltBaslik} Sonuçları</h3>
                                                                <div style="display:flex; row-gap:5px;flex-direction: inherit;">
                                            ...
                                            hesaplaPop.innerHTML = `<h3>${secilenAltBaslik} Sonuçları</h3>
                                                                <div style="display:flex; row-gap:5px;flex-direction: inherit;">
                                                                    <div><b>Yazılı Sınav Ortalaması: </b>${parseFloat(sinav1.value) + parseFloat(sinav2.value)}</div>
                                                                    <div><b>Performans Puan Ortalaması:</b> ${performans1.value}</div>
                                                                    <div><b>Dersin Dönem Puanı: </b>${(parseFloat(sinav1.value) + parseFloat(sinav2.value) + parseFloat(performans1.value)) / 3}</div>
                                                                </div>`
                                        } else if (sinav1.value !== "" && uygulama1.value !== "") {
                                            hesaplaPop.innerHTML = `<h3>${secilenAltBaslik} Sonuçları</h3>
                                                                <div style="display:flex; row-gap:5px;flex-direction: inherit;">
                                                                    <div><b>Yazılı Sınav Ortalaması: </b>${sinav1.value}</div>
                                                                    <div><b>Uygulama Puanı Ortalaması:</b> ${uygulama1.value}</div>
                                                                    <div><b>Dersin Dönem Puanı: </b>${(parseFloat(sinav1.value) + parseFloat(uygulama1.value)) / 2}</div>
                                                                </div>`
                                            ...
                                            hesaplaPop.innerHTML = `<h3>${secilenAltBaslik} Sonuçları</h3>
                                                                <div style="display:flex; row-gap:5px;flex-direction: inherit;">
                                                                    <div><b>Yazılı Sınav Ortalaması: </b>${sinav1.value}</div>
                                                                    <div><b>Performans Puan Ortalaması:</b> ${performans1.value}</div>
                                                                    <div><b>Dersin Dönem Puanı: </b>${(parseFloat(sinav1.value) + parseFloat(performans1.value)) / 2}</div>
                                                                </div>`
                                        } else if (sinav1.value !== "" && sinav2.value !== "") {
                                            hesaplaPop.innerHTML = `<h3>${secilenAltBaslik} Sonuçları</h3>
                                                                <div style="display:flex; row-gap:5px;flex-direction: inherit;">
                                                                    <div><b>Yazılı Sınav Ortalaması: </b>${sinav1.value}</div>
                                                                    <div><b>Dersin Dönem Puanı: </b>${(parseFloat(sinav1.value) + parseFloat(sinav2.value)) / 2}</div>
                                                                </div>`
                                        } else {
                                            alert('Hata oluştu.')
                                        }
                                    ...
                                    hesaplaPop.style = "display:flex;"
                                    hesaplaPop.innerHTML = `<h3>${secilenAltBaslik} Hesaplaması</h3>
                                                        <form style="display:flex; flex-direction:column;">
                                                            <input type="date" name="" id="girilenTarih" style="width:160px; padding:0px;">
                                                            <input type="submit" value="Hesapla" id="asiHesapla" style="width:33%;margin-top:5px;">
                                                        </form>`
                                    ...
                                    asiHesapla.addEventListener('click', function (event) {
                                        ...
                                        if (girilenTarih.value == '') {
                                            ...
                                            hesaplaPop.innerHTML = `<div>
                                                                    <h3>${secilenAltBaslik} Hesaplaması Sonuçları</h3>
                                                                    <div><b>Girilen Tarih: </b>${tarihStr}</div>
                                                                    <div><b>${tarihStr}(Doğumda): </b><span style="font-size:14px;">Hepatit-B 1. Aşı</span></div>
                                                                    <div><b>${yeniTarihStr}(2.Ay Sonunda):</b> <span style="font-size:14px;">BCG 1. Aşı, DaBT-İPA-Hib-HepB 1. Aşı, KPA 1. Aşı</span></div>
                                                                    <div><b>${yeniTarihStr2}(4.Ay Sonunda):</b> <span style="font-size:14px;">DaBT-İPA-Hib-HepB 2. Aşı, KPA 2. Aşı</span></div>
                                                                    <div><b>${yeniTarihStr3}(6.Ay Sonunda):</b> <span style="font-size:14px;">DaBT-İPA-Hib-HepB 3. Aşı, OPA 1. Aşı</span></div>
                                                                    <div><b>${yeniTarihStr4}(9.Ay Sonunda):</b> <span style="font-size:14px;">KKK Ek Doz</span></div>
                                                                    <div><b>${yeniTarihStr5}(12.Ay Sonunda):</b> <span style="font-size:14px;">KPA Pekiştirme Aşısı, KKK 1. Aşı, Su Çiçeği Aşısı</span></div>
                                                                    <div><b>${yeniTarihStr6}(18.Ay Sonunda):</b> <span style="font-size:14px;">KPA Pekiştirme Aşısı, KKK 1. Aşı, Su Çiçeği Aşısı</span></div>
                                                                    <div><b>${yeniTarihStr7}(24.Ay Sonunda):</b> <span style="font-size:14px;">KPA Pekiştirme Aşısı, KKK 1. Aşı, Su Çiçeği Aşısı</span></div>
                                                                    <div><b>${yeniTarihStr8}(48.Ay Sonunda):</b> <span style="font-size:14px;">KPA Pekiştirme Aşısı, KKK 1. Aşı, Su Çiçeği Aşısı</div>
                                                                </div>
                                                                `
                                        }
                                    })
                                    ...
                                    hesaplaPop.innerHTML = `<h3>${secilenAltBaslik}</h3>
                                                        <form>
                                                            <div style="text-align: start;width: 300px;">
                                                                    <div style="padding-left: 50px; margin-bottom:10px;"><b>Kilonuz: </b><input type="number" name="" id="kiloGiris" style="width:54%"></div>
                                                                ...
                                                                <div id="radioChange" style="display: flex;flex-direction: column;row-gap: 10px;">
                                                                    <div><label for="kadin">Kadın</label>
                                                                    <input type="radio" name="cinsiyet" id="kadin" value="kadin"></div>
                                                                    <div><label for="erkek">Erkek</label>
                                                                    <input type="radio" name="cinsiyet" id="erkek" value="erkek"></div>
                                                                </div><br>
                                                        ...
                                                        <div>
                                                            ...
                                                            <form style="flex-direction:column;row-gap: 12px;">
                                                                    <div style="margin-top: 7px;">
                                                                        ...
                                                                        <div><label for="dal">Günlük içilen sigara adedi (dal) ile</label>
                                                                        <input type="radio" name="sigara" id="dal" value="dal"></div>
                                                                        <div><label for="paket">Günlük içilen paket miktarı ile</label>
                                                                        <input type="radio" name="sigara" id="paket" value="paket"></div>
                                                                    </div>
                                                                <div>
                                                                    <b>Başlama Tarihi:</b>
                                                                ...
                                                                <div id="dalDiv" style="display: none;">
                                                                    ...
                                                                    <input type="number" name="" id="dalAdet">
                                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <form style="flex-direction:column; row-gap:10px;">
                                                        ...
                                                        <div id="boxDiv" style="width: 400px;margin-right: 27px;">
                                                            <div>
                                                                <b>Taban (a):</b><input type="number" name="" id="taban" style="margin-left: 27px;">
                                                            </div>
                                                            <div>
                                                                <b>Yükseklik (h):</b><input type="number" name="" id="yukseklik">
                                                            </div>
                                                        </div>
                                                        <div id="capDiv" style="display: none;">
                                                            <b>Yarıçap (r):</b><input type="number" name="" id="yaricap">
                                                        </div>
                                    ...
                                    alanHesapla.addEventListener('click', function (event) {
                                        ...
                                        if (kare.checked) {
                                            ...
                                            hesaplaPop.innerHTML = `<h3>${secilenAltBaslik} Sonuçları</h3>
                                        ${kareSonucm} metrekare ${kareSonuccm}santimetrekaredir`
                                        } else if (ucgen.checked) {
                                            let ucgenSonuccm = ((taban.value * yukseklik.value) / 2) / 10000
                                            let ucgenSonucm = (taban.value * yukseklik.value) / 2
                                            hesaplaPop.innerHTML = `<h3>${secilenAltBaslik} Sonuçları</h3>
                                        ${ucgenSonuccm} metrekare ${ucgenSonucm}santimetrekaredir`
                                        } else if (daire.checked) {
                                            ...
                                            hesaplaPop.innerHTML = `<h3>${secilenAltBaslik} Sonuçları</h3>
                                        ${daireSonucm} metrekare ${daireSonuccm}santimetrekaredir`
                                    ...
                                    hesaplaPop.style = "display:flex;"
                                    hesaplaPop.innerHTML = `<form style="flex-direction:column; row-gap:10px;">
                                                            ...
                                                            <div>
                                                                <b>Uzunluk: </b>
                                                                <input type="number" name="" id="uzunluk">
                                                            </div>
                                    ...
                                    incCmHesapla.addEventListener('click', function (event) {
                                        ...
                                        if (radioBox.value !== '' && uzunluk.value !== '') {
                                            if (incDeger.checked) {
                                                ...
                                                hesaplaPop.innerHTML = `                                            
                                            <h3>${secilenAltBaslik} Sonuçları</h3>
                                            <div><b>${uzunluk.value} inç</b> = ${deger} santimetredir</div>`
                                            }
                                            else if (cmDeger.checked) {
                                                let deger = uzunluk.value * 0.3937
                                                hesaplaPop.innerHTML = `                                            
                                            <h3>${secilenAltBaslik} Sonuçları</h3>
                                            <div><b>${uzunluk.value} santimetre</b> = ${deger} inçdir</div>`
                                            }
                                        } else {
                                            alert('Tüm alanların dolu olduğuna emin olunuz.')
                                        }
                                    ...
                                    cevreHesapla.addEventListener('click', function (event) {
                                        ...
                                        if (sekilGeo.value == '' || birKenar.value == '') {
                                            ...
                                            else if (sekilGeo.value == 'ikiz' && ikiKenar.value !== '' && birKenar.value !== '') {
                                                hesaplaPop.innerHTML = `<h3>${secilenAltBaslik} Sonuçları</h3>
                                            ...
                                            <div><b>Hesaplamak İstediğiniz Eşkenar Dikdörtgenin Çevresi: </b>${birKenar.value * 4} cm'dir</div>`
                                                ...
                                                hesaplaPop.innerHTML = `<h3>${secilenAltBaslik} Sonuçları</h3>
                                            <div><b>Hesaplamak İstediğiniz Düzgün (Eşkenar) Beşgenin Çevresi: </b>${birKenar.value * 5} cm'dir</div>`
                                            }
                                ...
                                <h3>${secilenAltBaslik}</h3>
                                    ...
                                    <div>
                                        <b>Uzunluk: </b>
                                        <input type="number" name="" id="uzunlukM">
                                    </div>
                                    ...
                                    milKmHesapla.addEventListener('click', function (event) {
                                        ...
                                        if (radioDeger.value !== '' && uzunlukM.value !== '') {
                                            if (milDeger.checked) {
                                                ...
                                                hesaplaPop.innerHTML = `
                                            <h3>${secilenAltBaslik} Sonuçları</h3>
                                            <div><b>${uzunlukM.value} mil =</b> ${deger} kilometredir</div>`
                                            } else if (kmDeger.checked) {
                                                let deger = uzunlukM.value * 0.621
                                                hesaplaPop.innerHTML = `
                                            <h3>${secilenAltBaslik} Sonuçları</h3>
                                            <div><b>${uzunlukM.value} kilometre =</b> ${deger} mildir</div>`
                                            }
                                        } else {
                                            alert('Tüm alanların dolu olduğuna emin olunuz.')
                                        }
                                    ...
                                    hesaplaPop.innerHTML = `
                                                        ...
                                                        <h3>${secilenAltBaslik}</h3>
                                                            ...
                                                            <div><b>A Sayısı: </b><input type="number" name="" id="aSayisi"></div>
                                                            <div><b>B Sayısı: </b><input type="number" name="" id="bSayisi"></div>
                                    ...
                                    hesaplaPop.innerHTML = `
                                                        <form style="flex-direction: column; row-gap:10px;">
                                                            ...
                                                            <div><b>Aylık Brüt Maaş: </b><input type="number" name="" id="brutMaas"></div>
                                    ...
                                    ihbarHesapla.addEventListener('click', function (event) {
                                        ...
                                        let ihbarFarkGun = Math.round(ihbarFarkMs / (1000 * 60 * 60 * 24))
                                        if (girisTarih.value == '' || cikisTarih.value == '' || brutMaas.value == '') {
                                            alert('Tüm alanların dolu olduğuna emin olunuz.')
                                        } else {
                                            if (ihbarFarkGun < 180) {
                                    ...
                                    hesaplaPop.innerHTML = `
                                                        ...
                                                        <h3>${secilenAltBaslik}</h3>
                                                            ...
                                                            <div><b>1. Ay Brüt Ücret:</b><input type="number" name="" id="brutMaas1"></div>
                                                            <div><b>2. Ay Brüt Ücret:</b><input type="number" name="" id="brutMaas2"></div>
                                                            <div><b>3. Ay Brüt Ücret:</b><input type="number" name="" id="brutMaas3"></div>
                                                            <div><b>4. Ay Brüt Ücret:</b><input type="number" name="" id="brutMaas4"></div>
                                    ...
                                    issizlikHesapla.addEventListener('click', function (event) {
                                        event.preventDefault()
                                        if (selectGun.value == '' || brutMaas1.value == '' || brutMaas2.value == '' || brutMaas3.value == '' || brutMaas4.value == '') {
                                            alert('Tüm alanların dolu olduğuna emin olunuz.')
                                        } else {
                                    ...
                                    hesaplaPop.innerHTML = `
                                                        <div>
                                                            <h3>${secilenAltBaslik}</h3>
                                                            <form style="flex-direction:column; row-gap:10px;">
                                                                <div style="margin-left: 50px;"><b>En: </b><input type="number" name="" id="en"> cm</div>
                                                                <div style="margin-left: 43px;"><b>Boy: </b><input type="number" name="" id="boy"> cm</div>
                                                                <div><b>Yükseklik: </b><input type="number" name="" id="yukseklik"> cm</div>
                                    ...
                                    hesaplaPop.innerHTML = `
                                                    <div>
                                                        <form style="flex-direction: column; row-gap: 10px;">
                                                            ...
                                                            <div id="normalD" style=" margin-left: -41px;"><b>Normal Fiyat: </b><input type="number" name="" id="normalF"></div>
                                                            <div id="indirimliD" style="display:none;"><b>İndirimli Fiyat:</b><input type="number" name="" id="indirimliF"></div>
                                                            <div id="oranD" style="margin-right: 78px;"><b>İndirim Oranı (%): </b><input type="number" name="" id="indirimO"></div>
                                    ...
                                    indirimHesapla.addEventListener('click', function (event) {
                                        event.preventDefault()
                                        if (indirimSelect.value == '0' && normalF.value !== '' && indirimO.value !== '') {
                                            ...
                                            hesaplaPop.innerHTML = `
                                                                ...
                                                                `
                                        } else if (indirimSelect.value == '1' && indirimliF.value !== '' && indirimO.value !== '') {
                                            ...
                                            hesaplaPop.innerHTML = `
                                                                ...
                                                                `
                                        } else if (indirimSelect.value == '2' && normalF.value !== '' && indirimliF.value !== '') {
                                    ...
                                    hesaplaPop.innerHTML = `
                                                    <div>
                                                        <form style="flex-direction: column; row-gap: 10px;">
                                                            ...
                                                            <div id="alisDiv" style="margin-left: 5px;"><b>Alış Fiyatı:</b><input type="number" name="" id="alis"></div>
                                                            <div id="satisDiv"><b>Satış Fiyatı:</b><input type="number" name="" id="satis"></div>
                                                            <div id="karDiv" style="display:none;"><b>Kâr Oranı (%):</b><input type="number" name="" id="kar"></div>
                                    ...
                                    karHesaplama.addEventListener('click', function (event) {
                                        event.preventDefault()
                                        if (karSelect.value == 'A' && alis.value !== '' & satis.value !== '') {
                                            ...
                                            hesaplaPop.innerHTML = `
                                                            ...
                                                            `
                                        } else if (karSelect.value == 'B' && alis.value !== '' && kar.value !== '') {
                                            ...
                                            hesaplaPop.innerHTML = `
                                                            ...
                                                            `
                                        } else if (karSelect.value == 'C' && satis.value !== '' && kar.value !== '') {
                                    ...
                                    hesaplaPop.innerHTML = `
                                                    <div>
                                                        <form style="flex-direction: column; row-gap: 10px;">
                                                            ...
                                                            <div id="normalDiv" style="margin-right: 12px;"><b>Normal Fiyatı:</b><input type="number" name="" id="normal"></div>
                                                            <div id="zamliDiv"><b>Zamlı Fiyatı:</b><input type="number" name="" id="zamli"></div>
                                                            <div id="zamOrDiv" style="display:none;"><b>Zam Oranı (%):</b><input type="number" name="" id="zamOr"></div>
                                    ...
                                    zamHesaplama.addEventListener('click', function (event) {
                                        event.preventDefault()
                                        if (zamSelect.value == 'D' && normal.value !== '' && zamOr.value !== '') {
                                            ...
                                            hesaplaPop.innerHTML = `
                                                            ...
                                                            `
                                        } else if (zamSelect.value == 'E' && normal.value !== '' && zamli.value !== '') {
                                            ...
                                            hesaplaPop.innerHTML = `
                                                            ...
                                                            `
                                        } else if (zamSelect.value == 'F' && zamli.value !== '' && zamOr.value !== '') {
                                    ...
                                    hesaplaPop.innerHTML = `
                                                    <div>
                                                        <form style="flex-direction: column; row-gap: 10px;">
                                                            ...
                                                            <div id="alisFDiv"><b>Alış Fiyatı: </b><input type="number" name="" id="alisF"></div>
                                                            <div id="satisFDiv" style="margin-right: 6px;"><b>Satış Fiyatı: </b><input type="number" name="" id="satisF"></div>
                                                            <div id="zararOrDiv" style="display:none;"><b>Zarar Oranı (%): </b><input type="number" name="" id="zararOr"></div>
                                    ...
                                    zararHesaplama.addEventListener('click', function (event) {
                                        event.preventDefault()
                                        if (zararSelect.value == 'G' && alisF.value !== '' && zararOr.value !== '') {
                                            ...
                                            hesaplaPop.innerHTML = `
                                                            ...
                                                            `
                                        } else if (zararSelect.value == 'H' && alisF.value !== '' && satisF.value !== '') {
                                            ...
                                            hesaplaPop.innerHTML = `
                                                            ...
                                                            `
                                        } else if (zararSelect.value == 'I' && satisF.value !== '' && zararOr.value !== '') {
